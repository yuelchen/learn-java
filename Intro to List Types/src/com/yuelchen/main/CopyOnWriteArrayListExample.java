...
/**
 * CopyOnWriteArrayListExample is for demonstrating operations that can be performed on List.
 * 
 * @author 	yuelchen
 * @version	1.0.0
 * @since	2020-09-22
...
public class CopyOnWriteArrayListExample {
	...
	public static void main(String[] args) {		
		...
		//creates a list for storing String - for concurrency
		List<String> listOfStrings = new CopyOnWriteArrayList<String>();
